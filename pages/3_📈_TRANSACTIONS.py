...
st.set_page_config(layout="wide", page_title="Transactions", page_icon="📈")
...
SELECT * FROM SCROLLSTATS.DBT_SCROLLSTATS.SCROLL_BD_TRANSACTIONS
''')

df = pd.DataFrame(raw_data)
df['MONTH'] = pd.to_datetime(df['MONTH'], format='%Y-%m-%d')
pivoted_df = df.pivot(index='NAME', columns='MONTH', values='NUM_TRANSACTIONS')
